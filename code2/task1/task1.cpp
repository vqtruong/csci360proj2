...
//         // constraints.push_back(make_tuple(1,ins.start_locations[1], ins.get_adjacent_locations(ins.start_locations[1]).front(),1));
        
//         //  constraints for Q2
//         // constraints.push_back(make_tuple(0,ins.goal_locations[0],-1,10));

//         //  constraints for Q3
//         constraints.push_back(make_tuple(1, 9, -1,1));
//         constraints.push_back(make_tuple(1, 8, -1,1));
